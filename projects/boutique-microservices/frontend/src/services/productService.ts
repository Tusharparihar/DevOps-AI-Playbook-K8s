...
const getImageUrl = (product: any): string => {
  ...
  // Backend is now handling image mapping. Keep absolute URLs as-is,
  // and normalize root-relative paths for deployments under a base path.
  if (product.image_url) {
    ...
    if (product.image_url.startsWith('/')) {
      return `${publicBase}${product.image_url}`;
    }
  ...
  // Default fallback
  return `${publicBase}/product-images/placeholder.jpg`;
};
